...
def run_nlu(model_directory):
	#interpreter = Interpreter.load('./models/nlu/default/customernlu', RasaNLUModelConfig('D:\\my_projects\\rasa_trial\\Rasa_chatbot\\customer_bot-master\\config_spacy.yml'))
	interpreter = Interpreter.load(model_directory)
	print(interpreter.parse(u"I am planning my to order an 829 router. How much does it cost?"))

if __name__ == '__main__':
	model_directory = train_nlu('./data/data.json', 'D:/my_projects/rasa_trial/Rasa_chatbot/customer_bot-master/config_spacy.yml', './models/nlu')
